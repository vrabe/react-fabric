import type {
  ImageProps as FabricImageProps,
  ObjectEvents,
...
const Image = forwardRef<Handle, ImageProps>(
  ({ group, src, onLoad, ...options }, ref) => {
    const instanceRef = useRef<FabricImage | undefined>(undefined)
    ...
    useEffect(() => {
      ...
      FabricImage.fromURL(src, { crossOrigin: "anonymous" }).then(
        (imageSource) => {

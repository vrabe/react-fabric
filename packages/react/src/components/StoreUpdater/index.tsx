...
export function StoreUpdater<NodeType extends Node = Node>(
  props: StoreUpdaterProps
) {
  const { reset, setMinManualZoom, setMaxManualZoom, setDefaultSelection } =
  ...
  useEffect(
    () => {
      for (const fieldName of fieldsToTrack) {
        ...
        else if (fieldName === "minManualZoom")
          setMinManualZoom(fieldValue as number)
        else if (fieldName === "maxManualZoom")
          setMaxManualZoom(fieldValue as number)
